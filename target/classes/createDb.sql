...
CREATE TABLE productos (
    ...
    precio_compra_proveedor DECIMAL(10,2),
...
-- 5. Productos
INSERT INTO productos (nombre_producto, id_categoria, stock_actual, precio_venta, precio_compra_proveedor, id_proveedor_principal, imagen_url) VALUES 
('Whisky Black Label 750ml', 1, 24, 95.00, 45.00, 3, '/images/puntoVenta/black_label.png'),
('Cerveza Pilsen Callao 620ml', 2, 120, 8.50, 4.20, 1, '/images/puntoVenta/pilsen.png'),
('Ron Cartavio Selecto 750ml', 3, 50, 45.00, 20.00, 2, '/images/puntoVenta/whisky.png'),
('Vino Tinto Intipalka Malbec', 4, 30, 38.00, 18.50, 4, '/images/puntoVenta/intipalka.png'),
('Tequila José Cuervo Especial', 5, 15, 65.00, 32.00, 6, '/images/puntoVenta/jose_cuervo.png'),
('Bolsa de Hielo Gourmet 3Kg', 6, 40, 7.00, 2.50, 5, '/images/puntoVenta/hielo.png');
